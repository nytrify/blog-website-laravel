...
@section('container')
<h1 class="row justify-content-center">{{ $title }}'s Posts</h1>
...
<div class="card mb-3">
    ...
    <div class="card-body text-center">
      ...
      <p>
        ...
        <br>
        Category: 
        <a href='/blog?categories={{ $posts[0]->category->slug }}' class="text-decoration-none">{{ $posts[0]->category->name }}</a>
    </p>
              ...
              <div class="position-absolute px-3 py-2 posts-category-title-tag">
                ...
                <div class="card-body">
                  ...
                  <small class="text-muted">
                    ...
                    <br>
                    Category: 
                    <a href='/blog?categories={{ $post->category->slug }}' class="text-decoration-none">{{ $post->category->name }}</a>
